...
class DrawInformation:
    ...
    def set_list(self, lst):
        ...
        self.block_width = round((self.width - self.SIDE_PDA) / len(lst))
        self.block_height = math.floor((self.height - self.TOP_PAD) / (self.max_val - self.min_val))
        self.start_x = self.SIDE_PDA // 2
...
def draw_list(draw_info: DrawInformation, color_positions={}, clear_bg=False):
    ...
    if clear_bg:
        clear_rect = (draw_info.SIDE_PDA // 2, draw_info.TOP_PAD, draw_info.width - draw_info.SIDE_PDA,
